/**
 * icons.jsx — Catálogo centralizado de íconos SVG
 *
 * Exporta:
 *  - SERVICE_ICONS   mapa iconKey → componente (para FEATURED_SERVICES)
 *  - CONTACT_ICONS   mapa iconKey → componente (para CONTACT_INFO)
 *  - Íconos nombrados individuales para uso directo
 *
 * Todos los SVG son inline (0 peticiones de red, tree-shakeable).
 * Tamaño base: h-6 w-6 — sobreescribir con className si se necesita diferente.
 */
...
export function HardHatIcon({ className = "h-6 w-6" }) {
  return (
    <svg {...BASE} className={className}>
...
export function SolarIcon({ className = "h-6 w-6" }) {
  return (
    <svg {...BASE} className={className}>
...
export function WhatsAppIcon({ className = "h-5 w-5" }) {
  return (
    <svg aria-hidden="true" className={className} fill="currentColor" viewBox="0 0 448 512">
...
// ─── Mapas iconKey → componente ───────────────────────────────────────────────

/** Mapa para resolver iconKey de FEATURED_SERVICES */
...
/** Mapa para resolver iconKey de CONTACT_INFO */
...
/** Mapa para resolver iconKey de SOCIAL_LINKS */
